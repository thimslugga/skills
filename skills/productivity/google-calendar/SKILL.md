...
description: Interact with Google Calendar via the Google Calendar API – list upcoming events, create new events, update or delete them. Use this skill when you need programmatic access to your calendar from Agentic AI Agents.
---
...
**Note:** This skill does not require a GUI; it works entirely via HTTP calls, so it is suitable for headless
